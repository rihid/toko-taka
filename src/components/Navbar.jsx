...
export default function Navbar() {
    ...
    return (
        <nav className="fixed w-full z-50 top-0 left-0 border-b border-gray-200">
            <div className="max-w-screen-xl flex items-center justify-between flex-wrap mx-auto p-4">
                ...
                <div className="flex md:order-2">
                    ...
                    <button type="button" onClick={() => setShowMenu(!showMenu)} className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
                ...
                >
                    <ul 
                        className={
                            `flex md:flex-row md:space-x-10 p-4 md:p-0 font-medium
                ...
                {/* {showMenu &&
                    <div className="md:hidden w-full items-center justify-between">
